...
SEED_USERS = [
    {
        ...
        "department": "National Disaster Management Authority (NDMA) HQ",
        "jurisdiction_district": "National / All State Emergency Centers",
...
SEED_HOTSPOTS = [
    ...
    },
    {
        ...
        "connected_villages": ["Pettimudi", "Nyamakad", "Rajamala", "Eravikulam Border"],
        "critical_infrastructure": [
...
SEED_DISTRICTS = [
    {
        ...
        "sensor_count": 12,
        "vulnerable_population": 4850,
        "primary_hotspots": ["Chooralmala", "Mundakkai", "Meppadi", "Vythiri"]
    },
    {
        ...
        "sensor_count": 8,
        "vulnerable_population": 3200,
        "primary_hotspots": ["Manohar Bagh", "Sunil Ward", "Marwari", "Helang"]
    },
    {
        "district": "Shimla",
        "state": "Himachal Pradesh",
        ...
        "sensor_count": 10,
        "vulnerable_population": 5400,
        "primary_hotspots": ["Summer Hill", "Totu", "Dhalli", "Theog"]
    },
    {
        ...
        "sensor_count": 9,
        "vulnerable_population": 2100,
        "primary_hotspots": ["Pettimudi", "Rajamala", "Devikulam"]
    },
    {
        ...
        "sensor_count": 7,
        "vulnerable_population": 1800,
        "primary_hotspots": ["Marappalam", "Coonoor", "Kotagiri"]
    }
]

SEED_MONTHLY_INCIDENTS = [
